...
namespace ConsumirApiExterna.Migrations
{
    ...
    [Migration("20250104174805_AddTabelaUsuarios")]
            ...
            modelBuilder.Entity("ConsumirApiExterna.Models.Location", b =>
                {
                    ...
                    b.Property<Guid>("CoordinatesIdCoordinates")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("TimezoneIdTimezone")
                        .HasColumnType("uuid");

                    b.HasKey("IdLocation");

                    b.HasIndex("CoordinatesIdCoordinates");

                    b.HasIndex("StreetIdStreet");

                    b.HasIndex("TimezoneIdTimezone");
            ...
            modelBuilder.Entity("ConsumirApiExterna.Models.Location", b =>
                {
                    b.HasOne("ConsumirApiExterna.Models.Coordinates", "Coordinates")
                        .WithMany()
                        .HasForeignKey("CoordinatesIdCoordinates")
                    ...
                    b.HasOne("ConsumirApiExterna.Models.Timezone", "Timezone")
                        .WithMany()
                        .HasForeignKey("TimezoneIdTimezone")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
